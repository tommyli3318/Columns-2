try:
	...
	import sys
	sys.exit("Pygame not installed, please pip install pygame")
...
def menu():
	...
	while True:
		...
		text_to_screen("Your last score: %s" % new_score,screen,(settings.screen_width/6,110),(255,255,255),20)
		text_to_screen("Your highest score: %s" % high_score,screen,(settings.screen_width/6,150),(255,255,255),20)
